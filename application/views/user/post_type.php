<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="card-title">Post Type List <div class="card-title float-md-right" style="float:right"><a class="btn btn-success" href="<?php echo base_url('user/addPostType'); ?>">Add Post</a></div></div>
        </div>
        <div class="card-body">
