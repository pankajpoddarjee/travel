  ...
  <div class="header-actions">
    ...
    <div class="dropdown ms-2">
      ...
      <div class="dropdown-menu dropdown-menu-end dropdown-menu-sm shadow-sm gap-3">
        <a class="dropdown-item d-flex align-items-center py-2" href="<?php echo base_url('user/account'); ?>"><i
            class="icon-gitlab fs-4 me-3"></i>User Profile</a>
        <a class="dropdown-item d-flex align-items-center py-2" href="<?php echo base_url('user/settings'); ?>"><i
            class="icon-settings fs-4 me-3"></i>Settings</a>
        <a class="dropdown-item d-flex align-items-center py-2" href="<?php echo base_url('user/changePassword'); ?>"><i
            class="icon-settings fs-4 me-3"></i>Change Password</a>
        <a class="dropdown-item d-flex align-items-center py-2" href="<?php echo base_url('user/logout'); ?>"><i
