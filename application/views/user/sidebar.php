...
<div class="app-brand px-3 py-2 d-flex align-items-center">
  <a href="index.html">
    <img src="<?php echo base_url('assets/images/logo.svg') ?>" class="logo" alt="Bootstrap Gallery" />
  </a>
</div>
<!-- App brand ends -->
...
<div class="sidebarMenuScroll">
  <ul class="sidebar-menu">
    ...
    <li>
      <a href="<?php echo base_url('user/chanel'); ?>">
        <i class="icon-pie-chart"></i>
        <span class="menu-text">Chanel</span>
      </a>
    </li>
    <li class="treeview">
      <a href="#!">
    ...
    <li>
      <a href="<?php echo base_url('user/post'); ?>">
