        ...
        <div class="container">
            <div class="booking p-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        <h1 class="text-white mb-4">Signup</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                    <input type="email" class="form-control bg-transparent" id="email" placeholder="Your Password">
                                    <label for="email">Your Password</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-outline-light w-100 py-3" type="submit">Sign Up</button>
                                </div>
                            </div>
                        </form>
                    </div>
